...
var insertAuthors = function () {
  r.db(config.db).table('Author').insert([
    {
      website:'http://guest.justonepixel.com',
      name:'Guest',
      id:'26227111-68fa-45d6-851a-d7e969d3e1f2',
      email:'guest@justonepixel.com',
    },
    {
      website:'http://marc.justonepixel.com',
      name:'Marc',
      id:'1f54250b-9cb2-4e07-9925-94c5b1df23f5',
      email:'marc@justonepixel.com',
    },
    {
      website:'http://blog.justonepixel.com',
      name:'Michel',
      id:'79db932d-c74d-4e94-86d9-e665bbc53519',
...
var insertComments = function () {
  r.db(config.db).table('Comment').insert([
    {
      postId:'431bedba-2c65-464a-a07f-a77270ba0266',
      name:'Maecenas',
      id:'10b8173c-2f4b-4d77-97bc-84f52292048e',
      date:r.now().sub(Math.random() * 365 * 24 * 60 * 60),
      comment:'Ut fringilla tincidunt rhoncus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Morbi vitae hendrerit arcu, nec accumsan magna. Aenean a vehicula ligula. Phasellus dapibus ultricies velit, a viverra diam pulvinar a.',
    },
    {
      postId:'936c9b54-1914-49ea-ba39-b41b00b9e463',
      name:'Callus',
      id:'d3110239-7120-437b-8e6c-f4630d24b2ed',
      date:r.now().sub(Math.random() * 365 * 24 * 60 * 60),
      comment:'Uis. Sed lobortis libero id elit rhoncus, molestie vestibulum dui consequat. Pellentesque dapibus vel sapien eget laoreet.',
    },
    {
      postId:'936c9b54-1914-49ea-ba39-b41b00b9e463',
      name:'Marcus',
      id:'df8386fb-f148-4c6c-b382-022c08b2a640',
      date:r.now().sub(Math.random() * 365 * 24 * 60 * 60),
      comment:'Vulputate ligula id sodales luctus. Nam at purus tempus, bibendum mauris vitae, feugiat velit. Etiam vitae vestibulum metus, in faucibus nibh. Maecenas sollicitudin lacus tortor, sit amet aliquet nisi porttitor a. Ut euismod, dui aliquam molestie ultricies, velit risus tincid,',
    },
    {
      postId:'936c9b54-1914-49ea-ba39-b41b00b9e463',
      name:'Seneque',
      id:'663d4bfb-e1ad-48b7-901c-e8b4acf75b0f',
      date:r.now().sub(Math.random() * 365 * 24 * 60 * 60),
      comment:'Per inceptos himenaeos. Nam vulputate ligula id sodales luctus. Nam at purus tempus, bibendum mauris vitae, feugiat velit. Etiam vitae vestibulum.',
    },
  ]).run(connection, function (error, result) {
    if (error) console.log(error);
